...
_CODE_SIGNALS = [
    # Language keywords
    "def ", "class ", "import ", "from ", "return ", "async def", "await ",
    "function ", "const ", "let ", "var ", "=>", "interface ", "type ",
    "struct ", "impl ", "fn ", "pub ", "mod ",
    # Code blocks
    "```", "~~~",
    # Common patterns
    "error:", "Error:", "exception:", "Exception:", "traceback",
    "Traceback", "TypeError", "ValueError", "KeyError", "AttributeError",
    "IndexError", "RuntimeError", "SyntaxError", "ImportError",
    # File signals
    ".py", ".ts", ".tsx", ".js", ".go", ".rs", ".java", ".cpp",
    # Stack traces
    "at line ", "line ", "File \"", "    at ",
    # Output signals
    "stdout", "stderr", "exit code", "status code", "HTTP ",
    "404", "500", "200 OK",
    # Dev signals
